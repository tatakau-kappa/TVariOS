...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-TVar/CollectionViewWaterfallLayout.framework"
  install_framework "Pods-TVar/FBSDKCoreKit.framework"
  install_framework "Pods-TVar/FBSDKLoginKit.framework"
